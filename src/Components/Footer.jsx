...
const Footer = () => {
  return (
    <footer className="bg-color1/70 font-bitter">
      ...
      <p className="text-xs md:text-sm font-medium text-center bg-color1/80 text-color2/60 py-1.5">
